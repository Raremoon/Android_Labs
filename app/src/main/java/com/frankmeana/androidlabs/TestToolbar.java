    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Floating Action button has been clicked...", Snackbar.LENGTH_LONG)
    ...
    public boolean onOptionsItemSelected(MenuItem mi){
        switch(mi.getItemId()){
            ...
            case R.id.action_happy:
                Log.d(ACTIVITY_NAME, "Happy selected");
            ...
            case R.id.action_money:
                Log.d(ACTIVITY_NAME, "Money selected");
            ...
            case R.id.action_about:
                ...
                Toast toast = Toast.makeText(TestToolbar.this, "V 1.0 by Frank Meana", Toast.LENGTH_LONG);
                toast.show();
                return true;
        }
        return false;
